        ...
        <div className={`hero-container ${darkMode === "true" ? "thema-hero" : ""}`}>
            <div className={`left-section ${darkMode === "true" ? "thema-left-section" : ""}`}>
                ...
                <div className={`button-container-hero ${darkMode === "true" ? "thema-button-container-hero" : ""}`}>
                    ...
                    <a href='https://github.com/Oguzhan-Akcay'><button className={`github-button ${darkMode === "true" ? "thema-github-button" : ""}`}> <img src={GithubLogo} alt="Github Logo" />         
                    Github</button></a>
                    <a href='https://www.linkedin.com/in/oguzhankcay/'><button className={`linkedIn-button ${darkMode === "true" ? "thema-linkedIn-button" : ""}`}> <img src={LinkedInLogo} alt="Linkedin Logo" />Linkedin</button>
</a>
                </div>
            </div>
            <div className={` right-section ${darkMode === "true" ? "thema-right-section" : ""}`}>
                <img className={`hero-photo ${darkMode === "true" ? "thema-hero-photo" : ""}`} src="/Oguz.png" alt="Oğuzhan Akçay" />
            </div>
        </div>
    );
}
